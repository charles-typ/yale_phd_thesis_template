...
% \newcommand{\smallcode}[1]{{\fontsize{9}{9}\selectfont\texttt{#1}}}
\newcommand{\smallcode}[1]{{\fontsize{8}{8}\selectfont\texttt{#1}}}

\newcommand{\draft}[1]{{\textcolor{red}{#1}}}

\newcommand{\consistent}[1]{{\textcolor{blue}{#1}}}
