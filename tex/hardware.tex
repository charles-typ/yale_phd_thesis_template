...
\centering
 \vspace{-0.2em}
  ...
  % include first image
  \includegraphics[width=0.5\textwidth]{fig/cxl/cxl_mix_workload0_c16_r0.pdf}
  \label{fig:readonly}}%
    \subfigure[Read:Write = $4$:$1$ workload]{
  % include first image
  \includegraphics[width=0.5\textwidth]{fig/cxl/cxl_mix_workload12_c16_r0.pdf}
  \label{fig:readwrite41}}%
  \\
  \subfigure[Read:Write = $3$:$1$ workload]{
  % include first image
  \includegraphics[width=0.5\textwidth]{fig/cxl/cxl_mix_workload3_c16_r0.pdf}
  \label{fig:readwrite31}}%
  \subfigure[Read:Write = $2$:$1$ workload]{
  % include first image
  \includegraphics[width=0.5\textwidth]{fig/cxl/cxl_mix_workload2_c16_r0.pdf}
  \label{fig:readwrite21}}%
  \backslash
  \subfigure[Read:Write = $1$:$1$ workload]{
  % include first image
  \includegraphics[width=0.5\textwidth]{fig/cxl/cxl_mix_workload5_c16_r0.pdf}
  \label{fig:readwrite11}}%
  \subfigure[Write-only workload]{
  % include first image
  \includegraphics[width=0.5\textwidth]{fig/cxl/cxl_mix_workload6_c16_r0.pdf}
  \label{fig:writeonly}}%
  \newline
  \subfigure[Read-only workload(random)]{
  % include first image
  \includegraphics[width=0.5\textwidth]{fig/cxl/cxl_mix_workload0_c16_r1.pdf}
  \label{fig:readdatasize}}%
    \subfigure[Write-only workload(random)]{
  % include first image
  \includegraphics[width=0.5\textwidth]{fig/cxl/cxl_mix_workload6_c16_r1.pdf}
...
\end{minipage}
\caption{\textbf{KeyDB Performance with YCSB-C on CXL/MMEM.}}
\vspace{-1.5em}
\end{figure}
...
\centering
 ...
 \includegraphics[width=\columnwidth]{fig/cxl/llm.pdf}
  \caption{\textbf{LLM inference framework.} The Httpserver receive requests and forward the tokenized requests to the CPU inference backend. The CPU inference backend serves the requests and reply the next token.}
...
\vspace{-0.5em}
\caption{\textbf{CPU LLM inference.} }
\vspace{-0.5em}
\end{figure*}
