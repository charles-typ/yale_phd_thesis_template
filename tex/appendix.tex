...
\begin{figure}[h]
  ...
  \vspace{-1em}
  \caption{{\textbf{\name controller performance.} Details in Appendix~\ref{ssec:controller-scale}.}}
...
\begin{figure*}[t]
  ...
  \caption{\textbf{\name sensitivity analysis} for (a) block size (b) lease duration and (c) repartition threshold for the file data structure. Green area corresponds to used capacity, while red area corresponds to allocated capacity under \name. See Appendix~\ref{ssec:sensitivity} for details.}
\end{figure*}
